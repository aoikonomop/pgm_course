...
for i = 1:size(genotypesToAlleles, 1)
    temp_assignments = assignments(ismember(sort(assignments(:, 2:end), 2), ...
        genotypesToAlleles(i, :), 'rows'), :);
    phenotypeFactor = SetValueOfAssignment(phenotypeFactor, ...
        temp_assignments, repmat([alphaList(i), 1 - alphaList(i)], ...
        size(temp_assignments, 1) / 2 ,1)');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
